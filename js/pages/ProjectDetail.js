...
function ProjectSection({ title, emoji, children }) {
    return React.createElement(
        'section',
        null,
        React.createElement('h2', { className: 'text-3xl font-bold mb-4 text-emerald-400' }, emoji + ' ' + title),
        children
    );
}
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            project.tech.map((tech, i) =>
                React.createElement('span', { key: i, className: 'px-4 py-2 bg-emerald-600 rounded-lg text-sm font-medium' }, tech)
            )
        ),
        React.createElement(
            'div',
            ...
            React.createElement(
                ...
                React.createElement('p', { className: 'text-gray-300 text-lg leading-relaxed' }, project.fullDescription)
            ),
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    project.results.map((result, i) =>
                        React.createElement(
                            'div',
                            { key: i, className: 'bg-zinc-900 border border-zinc-800 rounded-xl p-6' },
